...
## Switches
#set_property -dict { PACKAGE_PIN A8    IOSTANDARD LVCMOS33 } [get_ports { sel_in }]; #IO_L12N_T1_MRCC_16 Sch=sw[0]
...
set_property -dict { PACKAGE_PIN B8    IOSTANDARD LVCMOS33 } [get_ports { rst_uart }]; #IO_L12P_T1_MRCC_16 Sch=btn[3]
