...
HD_PWD='/home/aidin/Documents/University/Management_and_Analysis_of_Physics_Datasets/Laboratory/VHDL_Projects/baudrate_generator/baudrate_generator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Baudrate.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Baudrate.tcl
