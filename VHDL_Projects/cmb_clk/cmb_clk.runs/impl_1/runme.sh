...
HD_PWD='/home/aidin/Documents/University/Management_and_Analysis_of_Physics_Datasets/Laboratory/VHDL_Projects/cmb_clk/cmb_clk.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cmb_clk.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cmb_clk.tcl -notrace
