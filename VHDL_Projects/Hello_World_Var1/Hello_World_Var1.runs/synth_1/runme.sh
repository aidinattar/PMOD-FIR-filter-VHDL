...
HD_PWD='/home/aidin/Documents/University/Management and Analysis of Physics Datasets/Laboratory/VHDL_Projects/Hello_World_Var1/Hello_World_Var1.runs/synth_1'
cd "$HD_PWD"
